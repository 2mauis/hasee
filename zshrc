...
export PS1="$(print '@%{\e[1;33m%}%* %{\e[0m%}')%1~/$(print '%{\e[0;32m%}>>%{\e[0m%}') "
...
alias del='rm -i'
#文件关联
alias -s pdf=okular        #pdf文件用okular打开。。 
alias -s txt=vim
...
setopt auto_pushd # automatically pushd directories on dirstack  #启用cd 命令的历史纪录,cd 
##-[TAB]进入历史路径
...
zstyle ':completion:*:warnings' format $'\e[33m == \e[1;7;31m No Matches Found \e[m\e[0;33m 
==\e[m'
zstyle ':completion:*:corrections' format $'\e[33m == \e[1;7;37m %d (errors: %e) \e[m\e[0;33m 
==\e[m'
